...
VALUES (2, 1, DATEADD('DAY', -7, CURRENT_DATE), '08:30:00', 'BIKE', 'Fondo aeróbico', '3h 30m');

INSERT INTO TrainingBlock (trainingSessionId, blockOrder, name, sets, reps, distanceOrDuration, pace, rest, done)
VALUES (1, 1, 'Rodaje Z2', 1, 1, '3h 30m', 'Z2', '0', 1.0);

-- Sesión 2: Transición carrera
INSERT INTO TrainingSession (userId, coachId, sessionDate, startTime, sport, objective, totalDistanceOrDuration) 
VALUES (2, 1, DATEADD('DAY', -7, CURRENT_DATE), '12:00:00', 'RUN', 'Transición rápida', '5km');

INSERT INTO TrainingBlock (trainingSessionId, blockOrder, name, sets, reps, distanceOrDuration, pace, rest, done)
VALUES (2, 1, 'Carrera alegre', 1, 1, '5km', 'Z3', '0', 1.0);
...
-- Sesión 3: Natación
INSERT INTO TrainingSession (userId, coachId, sessionDate, startTime, sport, objective, totalDistanceOrDuration) 
VALUES (2, 1, DATEADD('DAY', -5, CURRENT_DATE), '07:15:00', 'SWIM', 'Fuerza en el agua', '2800m');

INSERT INTO TrainingBlock (trainingSessionId, blockOrder, name, sets, reps, distanceOrDuration, pace, rest, done)
VALUES (3, 1, 'Calentamiento + Palas', 1, 1, '1000m', 'AE1', '0', 1.0);
INSERT INTO TrainingBlock (trainingSessionId, blockOrder, name, sets, reps, distanceOrDuration, pace, rest, done)
VALUES (3, 2, 'Series con palas y pull', 8, 1, '200m', 'AE2', '20"', 1.0);
...
INSERT INTO TrainingBlock (trainingSessionId, blockOrder, name, sets, reps, distanceOrDuration, pace, rest, done)
VALUES (4, 1, 'Sentadilla pesada', 4, 5, '-', '85% RM', '2 min', 1.0);
...
INSERT INTO TrainingBlock (trainingSessionId, blockOrder, name, sets, reps, distanceOrDuration, pace, rest, done)
VALUES (5, 1, 'Calentamiento', 1, 1, '20min', 'Z1', '0', 1.0);
INSERT INTO TrainingBlock (trainingSessionId, blockOrder, name, sets, reps, distanceOrDuration, pace, rest, done)
VALUES (5, 2, 'Miles', 6, 1, '1km', 'Z4', '90"', 0.5); -- A medias
...
-- Sesión 6: Bici Tempo
INSERT INTO TrainingSession (userId, coachId, sessionDate, startTime, sport, objective, totalDistanceOrDuration) 
VALUES (2, 1, DATEADD('DAY', -3, CURRENT_DATE), '18:00:00', 'BIKE', 'Rodaje con cambios', '2h');

INSERT INTO TrainingBlock (trainingSessionId, blockOrder, name, sets, reps, distanceOrDuration, pace, rest, done)
VALUES (6, 1, 'Tempo sostenido', 3, 1, '20min', 'SweetSpot', '5 min Z1', 0.8);
...
-- Sesión 7: Natación
INSERT INTO TrainingSession (userId, coachId, sessionDate, startTime, sport, objective, totalDistanceOrDuration) 
VALUES (2, 1, DATEADD('DAY', -2, CURRENT_DATE), '08:00:00', 'SWIM', 'Recuperación activa', '2000m');

INSERT INTO TrainingBlock (trainingSessionId, blockOrder, name, sets, reps, distanceOrDuration, pace, rest, done)
VALUES (7, 1, 'Rodaje suave', 1, 1, '2000m', 'AE1', '0', 1.0);

-- Sesión 8: Carrera
INSERT INTO TrainingSession (userId, coachId, sessionDate, startTime, sport, objective, totalDistanceOrDuration) 
VALUES (2, 1, DATEADD('DAY', -2, CURRENT_DATE), '20:00:00', 'RUN', 'Trote', '45min');

INSERT INTO TrainingBlock (trainingSessionId, blockOrder, name, sets, reps, distanceOrDuration, pace, rest, done)
VALUES (8, 1, 'Trote cochinero', 1, 1, '45min', 'Z1', '0', 1.0);
...
-- Sesión 9: Transición
INSERT INTO TrainingSession (userId, coachId, sessionDate, startTime, sport, objective, totalDistanceOrDuration)
VALUES (2, 1, DATEADD('DAY', -1, CURRENT_DATE), '12:00:00', 'BRICK', 'Simulación de carrera', '1h');

INSERT INTO TrainingBlock (trainingSessionId, blockOrder, name, sets, reps, distanceOrDuration, pace, rest, done)
VALUES (9, 1, 'Primera transición', 1, 1, '5min', 'Ritmo de prueba', '0', 1.0);
INSERT INTO TrainingBlock (trainingSessionId, blockOrder, name, sets, reps, distanceOrDuration, pace, rest, done)
VALUES (9, 2, 'Bici con 5 minutos fuertes al principio y al final', 1, 1, '40min', 'Ritmo medio', '0', 1.0);
INSERT INTO TrainingBlock (trainingSessionId, blockOrder, name, sets, reps, distanceOrDuration, pace, rest, done)
VALUES (9, 3, 'Transición a correr', 1, 1, '5min', 'Ritmo de prueba', '0', 1.0);

-- Sesión 10: Fuerza
INSERT INTO TrainingSession (userId, coachId, sessionDate, startTime, sport, objective, totalDistanceOrDuration)
VALUES (2, 1, DATEADD('DAY', -1, CURRENT_DATE), '20:00:00', 'STRENGTH', 'Ejercicios de prevención', '30min');

INSERT INTO TrainingBlock (trainingSessionId, blockOrder, name, sets, reps, distanceOrDuration, pace, rest, done)
VALUES (10, 1, 'Movilidad de cadera', 1, 1, '10min', '0', '0', 1.0);
INSERT INTO TrainingBlock (trainingSessionId, blockOrder, name, sets, reps, distanceOrDuration, pace, rest, done)
VALUES (10, 2, 'Rutina de propiocepción', 8, 1, '10min', '0', '0', 1.0);
...
-- Sesión 11: Natación 
INSERT INTO TrainingSession (userId, coachId, sessionDate, startTime, sport, objective, totalDistanceOrDuration) 
VALUES ( 2, 1, CURRENT_DATE, '07:00:00', 'SWIM', 'Aeróbico ligero y técnica', '3400m');

INSERT INTO TrainingBlock (trainingSessionId, blockOrder, name, sets, reps, distanceOrDuration, pace, rest, done)
VALUES (11, 1, 'Calentamiento', 1, 1, '600m', 'AE1', '0', 1.0);
INSERT INTO TrainingBlock (trainingSessionId, blockOrder, name, sets, reps, distanceOrDuration, pace, rest, done)
VALUES (11, 2, 'Técnica crol', 12, 1, '50m', 'Técnica', '15"', 0.5);
INSERT INTO TrainingBlock (trainingSessionId, blockOrder, name, sets, reps, distanceOrDuration, pace, rest, done)
VALUES (11, 3, 'Nado largo', 4, 1, '400m', 'AE1-AE2', '1min', 0.0);

-- Sesión 12: Bici 
INSERT INTO TrainingSession (userId, coachId, sessionDate, startTime, sport, objective, totalDistanceOrDuration)
VALUES (2, 1, CURRENT_DATE, '09:00:00', 'BIKE', 'Ruta tranquila con 2 subidas largas', '3h');

INSERT INTO TrainingBlock (trainingSessionId, blockOrder, name, sets, reps, distanceOrDuration, pace, rest, done)
VALUES (12, 1, 'Puerto de Xiabre', 1, 1, '10km', 'Suave', '0', 0.0);
INSERT INTO TrainingBlock (trainingSessionId, blockOrder, name, sets, reps, distanceOrDuration, pace, rest, done)
VALUES (12, 2, 'Puerto de Iroite', 1, 1, '12km', 'Suave', '0', 0.0);

-- Sesión 13: Carrera 
INSERT INTO TrainingSession (userId, coachId, sessionDate, startTime, sport, objective, totalDistanceOrDuration)
VALUES (2, 1, CURRENT_DATE, '18:30:00', 'RUN', 'Series VO2Max', '10km');

INSERT INTO TrainingBlock (trainingSessionId, blockOrder, name, sets, reps, distanceOrDuration, pace, rest, done)
VALUES (13, 1, 'Calentar', 1, 1, '20min', 'R1', '0', 0.0);
INSERT INTO TrainingBlock (trainingSessionId, blockOrder, name, sets, reps, distanceOrDuration, pace, rest, done)
VALUES (13, 2, 'Series 400m', 8, 1, '400m', 'R3+', '1 min', 0.0);
...
-- Sesión 14: Natación
INSERT INTO TrainingSession (userId, coachId, sessionDate, startTime, sport, objective, totalDistanceOrDuration) 
VALUES (2, 1, DATEADD('DAY', 2, CURRENT_DATE), '07:30:00', 'SWIM', 'Series cortas de velocidad', '2500m');

INSERT INTO TrainingBlock (trainingSessionId, blockOrder, name, sets, reps, distanceOrDuration, pace, rest, done)
VALUES (14, 1, 'Calentamiento', 1, 1, '800m', 'AE1', '0', 0.0);
INSERT INTO TrainingBlock (trainingSessionId, blockOrder, name, sets, reps, distanceOrDuration, pace, rest, done)
VALUES (14, 2, 'Sprints 50m', 10, 1, '50m', 'Max', '30"', 0.0);

-- Sesión 15: Fuerza
INSERT INTO TrainingSession (userId, coachId, sessionDate, startTime, sport, objective, totalDistanceOrDuration) 
VALUES (2, 1, DATEADD('DAY', 2, CURRENT_DATE), '18:00:00', 'STRENGTH', 'Fuerza resistencia tren inferior', '1h');

INSERT INTO TrainingBlock (trainingSessionId, blockOrder, name, sets, reps, distanceOrDuration, pace, rest, done)
VALUES (15, 1, 'Prensa y extensiones', 4, 15, '-', '60% RM', '1 min', 0.0);
...
-- Sesión 16: Carrera
INSERT INTO TrainingSession (userId, coachId, sessionDate, startTime, sport, objective, totalDistanceOrDuration) 
VALUES (2, 1, DATEADD('DAY', 3, CURRENT_DATE), '19:30:00', 'RUN', 'Fartlek', '1h 10m');

INSERT INTO TrainingBlock (trainingSessionId, blockOrder, name, sets, reps, distanceOrDuration, pace, rest, done)
VALUES (16, 1, 'Fartlek 2min fuerte / 1 suave', 10, 1, '3min', 'Z4/Z2', '0', 0.0);
...
-- Sesión 17: Bici
INSERT INTO TrainingSession (userId, coachId, sessionDate, startTime, sport, objective, totalDistanceOrDuration) 
VALUES (2, 1, DATEADD('DAY', 4, CURRENT_DATE), '17:00:00', 'BIKE', 'Rodaje Recuperación', '1.5h');

INSERT INTO TrainingBlock (trainingSessionId, blockOrder, name, sets, reps, distanceOrDuration, pace, rest, done)
VALUES (17, 1, 'Soltar piernas', 1, 1, '1.5h', 'Z1', '0', 0.0);
...
INSERT INTO TrainingBlock (trainingSessionId, blockOrder, name, sets, reps, distanceOrDuration, pace, rest, done)
VALUES (18, 1, 'Nado continuo', 1, 1, '3000 m', 'AE2', '0', 0.0);
...
INSERT INTO TrainingBlock (trainingSessionId, blockOrder, name, sets, reps, distanceOrDuration, pace, rest, done)
VALUES (19, 1, 'Progresivo', 1, 1, '21 km', 'Z2 acabando Z3', '0', 0.0);
...
INSERT INTO TrainingSession (userId, coachId, sessionDate, startTime, sport, objective, totalDistanceOrDuration) 
VALUES (2, 1, DATEADD('DAY', 7, CURRENT_DATE), '08:30:00', 'BIKE', 'Salida con grupeta', '4h');

INSERT INTO TrainingBlock (trainingSessionId, blockOrder, name, sets, reps, distanceOrDuration, pace, rest, done)
VALUES (20, 1, 'Ruta libre', 1, 1, '4h', 'Z2 con picos', '0', 0.0);

INSERT INTO NutritionPlan (userId, coachId, planDate, targetCalories, proteinGrams, carbsGrams, fatGrams, hydrationLiters, guidelines, done)
VALUES (2, 1, DATEADD('DAY', 7, CURRENT_DATE), 4500, 170, 700, 110, 5.0, 'Llevar 2 bidones isotónico y barras.', 0.0);
