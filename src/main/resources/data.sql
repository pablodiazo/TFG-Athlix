...
VALUES (2, 1, CURRENT_DATE, 3800, 180, 500, 90, 4.0, 'Ingerir 2 litros de agua por la mañana.');

INSERT INTO RestPlan (userId, coachId, planDate, targetSleepHours, guidelines)
VALUES (2, 1, CURRENT_DATE, 8.5, 'Siesta de 20 min recomendada entre sesiones.');
...
-- Nutrición y Descanso para el día
INSERT INTO NutritionPlan (userId, coachId, planDate, targetCalories, proteinGrams, carbsGrams, fatGrams, hydrationLiters, guidelines)
VALUES (2, 1, DATEADD('DAY', -1, CURRENT_TIMESTAMP), 3800, 180, 1200, 90, 3.5, 'Importante la carga de hidratos pre-competición.');

INSERT INTO RestPlan (userId, coachId, planDate, targetSleepHours, guidelines)
VALUES (2, 1, DATEADD('DAY', -1, CURRENT_TIMESTAMP), 10, 'Siesta de 1 hora después de comer.');